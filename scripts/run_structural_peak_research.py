"""Run structural red/yellow peak research on market-only history."""
...
from modules.structural_peak_research import analyze_structural_peaks
...
def main() -> int:
    ...
    result = analyze_structural_peaks(frames, config)
