"""Run descriptive monthly-Dow/day-feature research on a market-only snapshot."""
...
from modules.dow_peak_research import analyze_universe
...
def main() -> int:
    ...
    print(json.dumps({"universe_stock_count": result["universe_stock_count"], "usable_stock_count": result["usable_stock_count"], "pivot_count": len(result["pivots"])}, ensure_ascii=False))
    return 0
