"""Run forward monthly-Dow / daily-exhaustion validation on market-only data."""
...
from modules.dow_peak_forecast_validation import validate_universe
...
def main() -> int:
    ...
    result = validate_universe(frames, config)
