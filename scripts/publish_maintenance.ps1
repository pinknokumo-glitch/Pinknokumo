...
$publishFiles = @(
    ...
    "tests/test_nonpeak_confluence_research.py",
    ...
    "tests/test_complete_condition_precision.py",
    ".github/workflows/multitimeframe-peak-research.yml",
    "modules/multitimeframe_peak_research.py",
    "scripts/run_multitimeframe_peak_research.py",
    "tests/test_multitimeframe_peak_research.py",
    ".github/workflows/dow-peak-forecast-validation.yml",
    "modules/dow_peak_forecast_validation.py",
    "scripts/run_dow_peak_forecast_validation.py",
    "tests/test_dow_peak_forecast_validation.py",
    ...
    "supabase/on_demand_analysis_upgrade.sql",
    "scripts/fail_analysis_request.py",
    "docs/ON_DEMAND_ANALYSIS.md",
    "tests/test_requested_analysis.py",
    "tests/test_cloud_stock_catalog.py",
    "tests/test_evening_universe.py",
    "modules/evening_universe.py",
    ...
    "modules/short_horizon_patterns.py",
    "modules/screener.py",
    ...
    "supabase/specified_stock_analysis_upgrade.sql",
